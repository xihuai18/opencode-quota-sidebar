...
describe("opencodeConfigPaths", () => {
  it("lists global, project, directory, and local override candidates in order", () => {
    assert.deepEqual(opencodeConfigPaths("/worktree", "/worktree/subdir"), [
      ...
      "/worktree/subdir/opencode.jsonc",
      "/worktree/subdir/opencode.json",
      "/worktree/.opencode/opencode.jsonc",
      "/worktree/.opencode/opencode.json",
      "/worktree/subdir/.opencode/opencode.jsonc",
      "/worktree/subdir/.opencode/opencode.json",
    ]);
  });
});
