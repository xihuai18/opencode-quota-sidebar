...
2. 显示支持的订阅制 / 余额制 provider 额度余量（OpenAI Codex、GitHub Copilot、Anthropic、Kimi For Coding、Zhipu Coding Plan、MiniMax Coding Plan、RightCode、XYAI）
...
| `src/providers/`            | Provider adapters（OpenAI/Copilot/Anthropic/Kimi/Zhipu/MiniMax/RightCode/XYAI） |
